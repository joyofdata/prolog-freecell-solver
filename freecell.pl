...
f(G1, G2, F1, F2, L1, [L2|L2s], L3, [S_|S], P, P_):-L2\=b, (L2=b;(L2\=b, L2=:=L2+1)), \+member([L1, L2s, L3], P), step_str(L2, 'L2', 'L2', S_), f(G1, G2, F1, F2, L1, L2s, L3, S, [[L1, L2s, L3]|P], P_).
...
f(G1, G2, F1, F2, L1, L2, [L3|L3s], [S_|S], P, P_):-L3\=b, (L3=b;(L3\=b, L3=:=L3+1)), \+member([L1, L2, L3s], P), step_str(L3, 'L3', 'L3', S_), f(G1, G2, F1, F2, L1, L2, L3s, S, [[L1, L2, L3s]|P], P_).
